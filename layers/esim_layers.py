...
from tensorflow.keras.layers import BatchNormalization, Embedding, Bidirectional, LSTM, concatenate, TimeDistributed, Dropout, Dense, GlobalAveragePooling1D, GlobalMaxPooling1D, Lambda
...
class MLPLayer(object):
    ...
    def __init__(self, hidden_units, n_classes, dropout=0.5,
        ...
        self.model.add(Dense(n_classes, kernel_initializer='zero',
                             activation=activations[1], name="output_dense_2"))
